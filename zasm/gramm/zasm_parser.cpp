...
#define yyparse         zasmparse
#define yylex           zasmlex
#define yyerror         zasmerror
#define yydebug         zasmdebug
#define yynerrs         zasmnerrs
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ZASM_DATA_SECTION = 3,          /* ZASM_DATA_SECTION  */
  YYSYMBOL_ZASM_CCODE_SECTION = 4,         /* ZASM_CCODE_SECTION  */
  YYSYMBOL_ZASM_XCODE_SECTION = 5,         /* ZASM_XCODE_SECTION  */
  YYSYMBOL_ZASM_INSTR = 6,                 /* ZASM_INSTR  */
  YYSYMBOL_ZASM_FLOAT_LITERAL = 7,         /* ZASM_FLOAT_LITERAL  */
  YYSYMBOL_ZASM_IDENTIFIER = 8,            /* ZASM_IDENTIFIER  */
  YYSYMBOL_ZASM_STRING_LITERAL = 9,        /* ZASM_STRING_LITERAL  */
  YYSYMBOL_ZASM_INTEGER_LITERAL = 10,      /* ZASM_INTEGER_LITERAL  */
  YYSYMBOL_ZASM_PRAGMA = 11,               /* ZASM_PRAGMA  */
  YYSYMBOL_ZASM_LEXICAL_ERROR = 12,        /* ZASM_LEXICAL_ERROR  */
  YYSYMBOL_13_ = 13,                       /* '{'  */
  YYSYMBOL_14_ = 14,                       /* '}'  */
  YYSYMBOL_15_ = 15,                       /* ':'  */
  YYSYMBOL_16_ = 16,                       /* ';'  */
  YYSYMBOL_YYACCEPT = 17,                  /* $accept  */
  YYSYMBOL_section_list = 18,              /* section_list  */
  YYSYMBOL_section = 19,                   /* section  */
  YYSYMBOL_data_section = 20,              /* data_section  */
  YYSYMBOL_data_list = 21,                 /* data_list  */
  YYSYMBOL_data_item = 22,                 /* data_item  */
  YYSYMBOL_data_elem_list = 23,            /* data_elem_list  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ZASM_DATA_SECTION",
  "ZASM_CCODE_SECTION", "ZASM_XCODE_SECTION", "ZASM_INSTR",
  "ZASM_FLOAT_LITERAL", "ZASM_IDENTIFIER", "ZASM_STRING_LITERAL",
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, yyscan_t yyscanner, zasm_driver_t *driver)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yyscanner);
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, yyscan_t yyscanner, zasm_driver_t *driver)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, yyscan_t yyscanner, zasm_driver_t *driver)
{
  YY_USE (yyvaluep);
  YY_USE (yyscanner);
  YY_USE (driver);
...
int
yyparse (yyscan_t yyscanner, zasm_driver_t *driver)
{
